...
const StatsAuthController = () => import('#controllers/stats_auth_controller')
...
router.get('/stats/login', [StatsAuthController, 'showLogin'])
router.post('/stats/login', [StatsAuthController, 'login'])
router.post('/stats/logout', [StatsAuthController, 'logout'])
